...
## 事業展開
- 働く人の健康を守り、生産性を高めるコンサルティング
- 働く人・集団の健康度を高めて、行動変容につなげるセミナー・研修
- 医療従事者向け（医師・産業医・看護師・保健師）の教育研修

### :star:「満足度の高い講演をお約束」企画案
...
## 合成音声＋スライド＝話す「紙芝居」動画:notes:<BR>作成プログラムによる自動作成🏆 コストゼロ！できます
<!-- _backgroundColor: "#ffe0e0" -->
| 動画コンテンツ 例                                                                     | 内容🎶                                                            |
| ------------------------------------------------------------------------------------- | ---------------------------------------------------------------- |
